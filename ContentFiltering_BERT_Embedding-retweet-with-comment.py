...
user_tokens = pd.read_csv('s3://recsys-challenge-2020/user_tokens_retweet_with_comment.csv')
...
user_val_set_retweet_with_comment_score = pd.DataFrame()
...
time1 = time.time()
user_val_set_retweet_with_comment_score['retweet_with_comment_score'] = user_tokens_val_set.apply (lambda z: calculate_average(z.text__tokens_y, z.text__tokens_x, z.name, time1), axis = 1)
time2 = time.time()
print(time2 - time1)
...
user_val_set_retweet_with_comment_score.to_csv('s3://recsys-challenge-2020/user_retweet_with_comment_score.csv', index = False)
